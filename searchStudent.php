<?php
    ...
    $records_per_page = 5;
    $student_count = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM students WHERE CONCAT(student_first_name, ' ',
    student_last_name, ' ',
    student_address, ' ',
    student_mobile, ' ',
    ...
    // $get_student_data = "SELECT * FROM students LIMIT $start,$records_per_page LIMIT $start,$records_per_page";
    // $student_data_res = mysqli_query($conn,$get_student_data);
    $get_student_data = "SELECT * FROM students WHERE CONCAT(student_first_name, ' ',
        student_last_name, ' ',
        student_address, ' ',
        student_mobile, ' ',
        student_email) LIKE '%$search%' LIMIT $start,$records_per_page";
    $student_data_res = mysqli_query($conn,$get_student_data);
    }
?>
<!-- Table  -->
<div class="container my-5">
  ...
  <div class="my-3 row">
    <div class="col">
      <form class="form-inline" action="searchStudent.php" method="get">
        <input class="form-control mr-sm-2" type="search" name="search" placeholder="Search" value="<?php echo $search; ?>" aria-label="Search" id="searchInput">
  ...
  <ul class="pagination mt-30">
    <?php 
      ...
      ?>
        <li class="page-item"><a class="page-link" href="?start=<?php echo $i?>&search=<?php echo $search; ?>"><?php echo $i?></a></li>
      <?php
      }
      } 
     ?>
